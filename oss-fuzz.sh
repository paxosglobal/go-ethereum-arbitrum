...
coverpkg="github.com/paxosglobal/go-ethereum-arbitrum/..."
...
repo=$GOPATH/src/github.com/paxosglobal/go-ethereum-arbitrum
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/accounts/abi \
  FuzzABI fuzzAbi \
...
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/core/vm/runtime \
  FuzzVmRuntime fuzzVmRuntime\
  $repo/core/vm/runtime/runtime_fuzz_test.go

compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/core/vm \
  FuzzPrecompiledContracts fuzzPrecompiledContracts\
  $repo/core/vm/contracts_fuzz_test.go,$repo/core/vm/contracts_test.go

compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/core/types \
  FuzzRLP fuzzRlp \
  $repo/core/types/rlp_fuzzer_test.go

compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/crypto/blake2b \
  Fuzz fuzzBlake2b \
  $repo/crypto/blake2b/blake2b_f_fuzz_test.go

compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/accounts/keystore \
  FuzzPassword fuzzKeystore \
  $repo/accounts/keystore/keystore_fuzzing_test.go

pkg=$repo/trie/
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/trie \
  FuzzTrie fuzzTrie \
...
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/eth/protocols/snap \
...
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/tests/fuzzers/bn256 \
...
compile_fuzzer github.com/paxosglobal/go-ethereum-arbitrum/tests/fuzzers/txfetcher \
  Fuzz fuzzTxfetcher \
